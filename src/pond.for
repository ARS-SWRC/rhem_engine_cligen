...
C------------------------------------------------------------------------------
     ...
     &        latc(2,5), upr(10), latr(2), ms, ngage, nr, nq, nc !, nps, limit
...
C##
        if(diag) then
C          write(99,877)time,qlat,qup,q2,v2,sa2
C 876  format(' time/60.  qlat     qup      qout       vol       surfA ')
C          write(99,'("k ",I4)') k
C 877  format(f8.2, 3g11.3, 2f10.2) 
        end if

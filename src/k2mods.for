...
C        integer, parameter  :: mxplan = 75
        logical :: sed, cour, chrain, tabl, vapi, suma
...
C** new dx max here for reality check
        real    :: clen, tfin, delt, conv, wt, arconv, wconv, xnu,
     &             thfc, thwilt, thinu, satfc, satwl, satin
...
C            during each quarter of the simulation
        ...
        real,dimension(10000) :: time_hyd_min, time_hyd_max
        integer, dimension(5) :: nord
        real :: grav, temp, bdep, time_runoff_dur   
...
!   rsoil           = real soil (not fixed f or impervious)
        integer :: nprint, ltyp, id, nchan , ndv, infmode !, nchs
